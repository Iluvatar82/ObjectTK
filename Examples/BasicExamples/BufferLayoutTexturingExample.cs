...
namespace Examples.BasicExamples
{
    ...
    public class BufferLayoutTexturingExample : ExampleWindow
    {
        /// <summary>
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            _sampler.SetParameter(SamplerParameterName.TextureMinFilter, (int)(_enableMipmapping ? TextureMinFilter.NearestMipmapLinear : TextureMinFilter.Nearest));
